        ...
        if self.type == DataConnectionTypes.S3:
            ...
            if self._check_if_connection_asset_is_s3():
                ...
                try:
                    ...
                    attachment = get_data_asset_attachment(data_location, self._wml_client)
            ...
            if self._check_if_connection_asset_is_s3():
                ...
                try:
                    ...
                    attachment = {
                        ...
                        "interaction_properties": self.location.to_dict()}

                    try_import_pyarrow()

                    flight_service = FlightService(
                        wml_client=self._wml_client,
                        entity=connection_details['entity'],
                        attachment=attachment,
                        data_location={'location': data_location, 'type': self.type},
                        params=self.auto_pipeline_params
                    )
